  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '全量产品库', productView: 'all' },
      },
      {
        path: 'product/cooperate',
        name: 'PartnerProductList',
        component: () => import('@/views/product/ProductList.vue'),
        meta: { title: '合作产品库', productView: 'cooperate' },
      },
      {
        path: 'rule',
        name: 'RuleList',
      ...
      },
      {
        ...
        meta: { title: '员工管理', permission: 'page:org', orgView: 'staff' },
      },
      {
        path: 'org/roles',
        name: 'OrgRoles',
        component: () => import('@/views/org/OrgCenter.vue'),
        meta: { title: '角色权限', permission: 'page:org', orgView: 'role' },
      },
      {
        path: 'org/api-permissions',
        name: 'OrgApiPermissions',
        component: () => import('@/views/org/OrgCenter.vue'),
        meta: { title: '接口权限', permission: 'page:org', orgView: 'api' },
      },
      {
        path: 'lead',
        redirect: '/lead/my',
      },
      {
        ...
        meta: { title: '我的线索', leadView: 'mine' },
      },
      {
        path: 'lead/pool',
        name: 'LeadSea',
        component: () => import('@/views/lead/LeadPool.vue'),
        meta: { title: '线索公海', leadView: 'pool' },
      },
      {
        path: 'client',
        redirect: '/client/my',
      },
      {
        ...
        meta: { title: '我的客户', permission: 'page:client', clientScope: 'MY' },
      },
      {
        path: 'client/team',
        name: 'TeamClients',
        component: () => import('@/views/client/ClientProfile.vue'),
        meta: { title: '团队客户', permission: 'page:client', clientScope: 'TEAM' },
      },
      {
        path: 'client/company',
        name: 'CompanyClients',
        component: () => import('@/views/client/ClientProfile.vue'),
        meta: { title: '全司客户', permission: 'page:client', clientScope: 'ALL' },
      },
      {
        path: 'client/company-sea',
        name: 'CompanyClientSea',
        component: () => import('@/views/client/ClientProfile.vue'),
        meta: { title: '客户公海', permission: 'page:client', clientScope: 'COMPANY_SEA' },
      },
      {
        path: 'client/team-sea',
        name: 'TeamClientSea',
        component: () => import('@/views/client/ClientProfile.vue'),
        meta: { title: '团队公海', permission: 'page:client', clientScope: 'TEAM_SEA' },
      },
      {
        path: 'client-lookup',
        name: 'ClientLookup',
        component: () => import('@/views/client/ClientLookup.vue'),
        meta: { title: '客户检索', permission: 'page:client' },
      },
      {
        path: 'ocr',
        name: 'OcrCenter',
      ...
      },
      {
        ...
        redirect: '/service-operations/daily',
      },
      {
        path: 'service-operations/daily',
        name: 'ServiceDaily',
        component: () => import('@/views/service/ServiceOperations.vue'),
        meta: { title: '今日服务台', serviceView: 'daily' },
      },
      {
        path: 'service-operations/appointments',
        name: 'ServiceAppointments',
        component: () => import('@/views/service/ServiceOperations.vue'),
        meta: { title: '客户预约', serviceView: 'appointments' },
      },
      {
        path: 'service-operations/outings',
        name: 'ServiceOutings',
        component: () => import('@/views/service/ServiceOperations.vue'),
        meta: { title: '员工外出', serviceView: 'outings' },
      },
      {
        path: 'service-operations/replay',
        name: 'ServiceReplay',
        component: () => import('@/views/service/ServiceOperations.vue'),
        meta: { title: '客户回放', serviceView: 'replay' },
      },
      {
        path: 'reward',
      ...
      {
        path: 'approval/product',
        name: 'ApprovalProduct',
        component: () => import('@/views/approval/ApprovalCenter.vue'),
        meta: { title: '产品审核' },
      },
      {
        path: 'approval/download',
        name: 'ApprovalDownload',
        component: () => import('@/views/approval/ApprovalCenter.vue'),
        meta: { title: '附件下载审核' },
      },
      {
      ...
      {
        path: 'approval/sms-template',
        name: 'ApprovalSmsTemplate',
        component: () => import('@/views/approval/ApprovalCenter.vue'),
        meta: { title: '短信模板审核' },
      },
      {
        path: 'approval/report-template',
        name: 'ApprovalReportTemplate',
        component: () => import('@/views/approval/ApprovalCenter.vue'),
        meta: { title: '报告模板审核' },
      },
      {
      ...
      },
      {
        ...
        meta: { title: '短信模板', smsView: 'template' },
      },
      {
        path: 'sms/records',
        name: 'SmsRecords',
        component: () => import('@/views/sms/SmsCenter.vue'),
        meta: { title: '发送记录', smsView: 'record' },
      },
      {
