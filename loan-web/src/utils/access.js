...
export const ACTION_PERMISSION = Object.freeze({
  ...
  CONTENT_AUDIT: 'approval:content:audit',
  ORDER_CREATE: 'order:create',
  ORDER_STATUS: 'order:status',
  BLACKLIST_ADD: 'blacklist:add',
  BLACKLIST_RELEASE: 'blacklist:release',
});
...
const ROLE_DEFAULT_PERMISSIONS = Object.freeze({
  ...
  OPERATOR: Object.freeze([
    'page:client', 'page:audit', 'page:sms', 'page:report-template',
    ACTION_PERMISSION.LEAD_CREATE, ACTION_PERMISSION.LEAD_CLAIM,
    ACTION_PERMISSION.CLIENT_POOL_VIEW, ACTION_PERMISSION.CLIENT_CLAIM,
    ACTION_PERMISSION.CLIENT_UPDATE, ACTION_PERMISSION.CLIENT_SCREENING,
    ACTION_PERMISSION.PRODUCT_AUDIT, ACTION_PERMISSION.DOWNLOAD_AUDIT,
    ACTION_PERMISSION.DOWNLOAD_VOID, ACTION_PERMISSION.ALLOCATION_AUDIT,
    ACTION_PERMISSION.CONTENT_AUDIT,
    ACTION_PERMISSION.ORDER_CREATE, ACTION_PERMISSION.ORDER_STATUS,
  ]),
