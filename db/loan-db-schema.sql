...
CREATE TABLE `t_client_allocation_approval` (
  ...
  `approval_stage` varchar(20) NOT NULL DEFAULT 'TEAM_REVIEW' COMMENT '审批阶段(TEAM_REVIEW/BOSS_REVIEW)',
  `team_approver_staff_code` varchar(32) DEFAULT NULL COMMENT '团队初审人',
  `team_approved_at` datetime DEFAULT NULL COMMENT '团队初审时间',
