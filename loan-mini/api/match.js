 ...
 * @param {boolean} [payload.showError=true] 是否由请求层自动提示错误；页面自行处理时传 false
 ...
 * @returns {Promise<Array<{productName,bankName,amountRange,rate,term,matchScore}>>}
 * tags / requirement 由后端数据链路补齐后再作为可选展示字段使用。
 */
