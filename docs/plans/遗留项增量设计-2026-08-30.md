...
| `06-业务结论沉淀索引（C1-C26）.md` | 扩为 C1-C22：**C20** 渠道线索录入（归属=公海/沙箱脱敏/source 字典修正）、**C21** OCR 回灌诊断（三层链路/仅补空/Mock 可插拔/`_ocrMeta` 版本）、**C22** 审批中心统一（视图层统一，建表迁移列阶段四）；C5 追加行业均值表化 |
